...
public class MyGraphEval
{
	...
	public static void main(String[] args) {
		...
		for (Object object : tempArgs) {
			...
			System.out.println("Remaining arguments: " + object.toString());
		}
		...
		if (remainArgs.size() == 5) {
			...
			System.out.println("Vertices file name: " + verticesOutFilename);
		...
		if (inputFilename != null) {
			...
			try {
		    	...
		    	while ((line = reader.readLine()) != null) {
		    		...
		    		verticesSet.add(srcLabel);
		    		edges++;
		    	}
		    	int vertices = verticesSet.size();
		    	double dblverts = (double) vertices;
		    	double dbledges = (double) edges;
		    	double density = 100.0 * dbledges / (dblverts * dblverts);
		    	System.out.printf("\nThe file has been read with %5d vertices and %5d edges.", vertices, edges);
		    	System.out.println("Double vertices: " + dblverts + " double edges: " + dbledges + " double density: " + String.format("%.2f", density) + "%");
			}
